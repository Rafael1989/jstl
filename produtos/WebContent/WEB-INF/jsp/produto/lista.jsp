...
<body>
	...
	<table width="100%">
		...
		<c:forEach var="p" items="${produtoList}" varStatus="contador">
			<tr id="produto${p.id}">
	...
	<c:url value="/produto/formulario" var="adicionaProdutoUrl"></c:url>
	<a href="${adicionaProdutoUrl}"><fmt:message key="mensagem.novoProduto"/></a>
